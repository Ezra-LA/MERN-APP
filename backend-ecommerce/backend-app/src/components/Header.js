...
import user from "../images/images/user.svg";
import cart from "../images/images/cart.svg";
    ...
    <>
      <header className="header-top-strip py-3">
        <div className="container-xxl">
          <div className="row">
            <div className="col-6">
              <p className="text-white mb-0">Free Shipping Over ksh 10000 & Free Returns</p>
            </div>
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline:<a className="text-white" href="tel:+254 769 478 664">+254 769 478 664</a>
                </p>
            </div>
          </div>
        </div>
      ...
      <header className="header-upper py-3">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <h2>
                <Link className="text-white">Yeswa.</Link>
              </h2>
            </div>
