      ...
      <Sider trigger={null} collapsible collapsed={collapsed}>
        <div className="logo">
          <h2 className="text-white fs-5 text-center py-3 mb-0">
            <span className="sm-logo">YW</span>
            <span className="lg-logo">Yeswa</span>
          </h2>
        </div>
        <Menu
          theme="dark"
          ...
          <div className="d-flex gap-4 align-items-center">
            ...
            <div
             className="d-flex gap-3 align-items-center dropdown" >
              <div>
                <img width={48} height={64} src="images/ELA.jpg" alt="" />
              </div>
              <div
               role="button" 
                id="dropdownMenuLink" 
                ...
                aria-expanded="false">
                <h5 className="mb-0">Ezra</h5>
                <p className="mb-0">mrluvaha@gmail.com</p>
              </div>
              <div
